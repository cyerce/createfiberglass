package net.aepherastudios.createfiberglass.blocks;

import net.aepherastudios.createfiberglass.CreateFiberglass;
import net.aepherastudios.createfiberglass.item.ModItems;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, CreateFiberglass.MOD_ID);
